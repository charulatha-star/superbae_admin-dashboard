...
export default function PartnersPage() {
  ...
  const tabs: TabItem[] = [
    ...
    { id: 'usage', label: 'Usage & Reports', panel: usageReportsPanel },
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>Manage relationships, shared spaces, and related features.</p>
      </div>
      <Tabs tabs={tabs} defaultTab="overview" ariaLabel="Partner feature sections" />
    </div>
  );
}
