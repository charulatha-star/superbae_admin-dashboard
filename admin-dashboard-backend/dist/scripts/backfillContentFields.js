 ...
 */
const CONTENT_RESOURCES = ['affirmations', 'zodiac', 'tips', 'banners', 'journalPrompts'];
...
async function backfillResource(resource) {
    const collection = registry_1.models[resource];
    if (!collection) {
...
async function backfillContentFields() {
