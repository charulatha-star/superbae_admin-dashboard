...
async function seedPersonal() {
    ...
    await Promise.all([
        registry_1.models.goals.deleteMany({}),
        registry_1.models.bucketList.deleteMany({}),
        registry_1.models.memories.deleteMany({}),
        registry_1.models.myCircle.deleteMany({}),
        registry_1.models.lifeTimeline.deleteMany({}),
        registry_1.models.fits.deleteMany({}),
    ]);
    console.log('  Done.\n');
    ...
    for (const userId of allUserIds) {
        ...
        for (let i = 0; i < goalCount; i++) {
            ...
            await registry_1.models.goals.create({
        ...
        for (let i = 0; i < bucketCount; i++) {
            ...
            await registry_1.models.bucketList.create({
        ...
        for (let i = 0; i < memoryCount; i++) {
            ...
            await registry_1.models.memories.create({
        ...
        for (let i = 0; i < circleCount; i++) {
            ...
            await registry_1.models.myCircle.create({
        ...
        for (let i = 0; i < timelineCount; i++) {
            ...
            await registry_1.models.lifeTimeline.create({
        ...
        for (let i = 0; i < fitCount; i++) {
            ...
            await registry_1.models.fits.create({
    ...
    const [totalGoals, totalBucketList, totalMemories, totalMyCircle, totalLifeTimeline, totalFits,] = await Promise.all([
        registry_1.models.goals.countDocuments(),
        registry_1.models.bucketList.countDocuments(),
        registry_1.models.memories.countDocuments(),
        registry_1.models.myCircle.countDocuments(),
        registry_1.models.lifeTimeline.countDocuments(),
        registry_1.models.fits.countDocuments(),
    ]);
